/**
 * `@common-grants/cg-federal` — CommonGrants plugin for the federal grant data
 * standards, centered on the Notice of Funding Opportunity (NOFO) Information
 * Collection (IC).
 *
 * Extends the CommonGrants `Opportunity` schema with federal-specific custom
 * fields and provides bidirectional transforms between the NOFO IC source shape
 * and the CommonGrants Opportunity schema. See TRANSFORMS.md for the field
 * mapping.
 */
...
export const SOURCE_SYSTEM = "Federal NOFO IC";

/**
 * CommonGrants plugin for the federal NOFO IC.
 *
 * @example
 * ```ts
 * import plugin from "@common-grants/cg-federal";
 *
 ...
 *
 * // Validate CommonGrants-shaped data with federal custom fields
