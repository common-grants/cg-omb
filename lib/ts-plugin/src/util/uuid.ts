...
/**
 * Namespace UUID for the federal plugin's deterministic ids. Fixed constant — do
 * not change, or previously-derived opportunity ids will no longer match.
 */
export const FEDERAL_NAMESPACE = "6f9b1a3e-8c2d-4e5f-a1b0-3c4d5e6f7a8b";
 ...
 */
export function uuidv5(name: string, namespace: string = FEDERAL_NAMESPACE): string {
