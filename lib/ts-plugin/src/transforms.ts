...
// =============================================================================
// Applicant-type mappings (federal EligibleApplicantEntityTypeCode → CG value)
// =============================================================================

/**
 * Federal applicant-type code → CommonGrants `acceptedApplicantTypes` value.
 * Empty until the federal entity-type domain values are crosswalked; until then all
...
export function fromCommon(common: any): TransformResult<NofoIc> {
  ...
  const result: NofoIc = {
    ...
    // the data came from another source system with no federal projects) synthesize
