...
/**
 * Custom-field value schemas for the federal NOFO IC plugin's `Opportunity` schema.
 *
 * These mirror the `cg-custom` rows of the federal ↔ CommonGrants data-mapping
