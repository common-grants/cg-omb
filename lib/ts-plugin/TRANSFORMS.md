...
`@common-grants/cg-federal` maps the federal **NOFO Information Collection** to the
...
- **Applicant types (2.01.01):** `APPLICANT_TYPE_TO_COMMON` maps federal
  ...
  Populate the table once the federal entity-type domain values are crosswalked.
